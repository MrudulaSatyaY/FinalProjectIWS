...
<body>
	<div class="container">
		...
		<section id="main_section" class="main">
			...
			<div id="topic_1" class="topic"> topic 1</div>
			<div id="topic_2" class="topic">topic 2</div>
			<div id="topic_3" class="topic">topic 3</div>
			<div id="topic_4" class="topic">topic 4</div>
			<div id="topic_5" class="topic">topic 5</div>
			<div id="topic_6" class="topic">topic 6</div>
			</section>	
